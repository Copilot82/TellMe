...
> [!IMPORTANT]
> Разработка и сопровождение проекта прекращены. Внешние pull request, issues и запросы на
> внедрение не рассматриваются. Репозиторий опубликован как законченный инженерный пример и
> исходная база, которую организация может развивать собственными силами.
